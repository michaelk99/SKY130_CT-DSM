...
function [y, fs, N, w1, w2, w3, w4, w1_in, w2_in, w3_in, w4_in] = simDSM4CT_FB_2bit_nonlin(OSR, ctSteps, fb, fin, fres, amplitude, offset, amplitude_inter, finter, omCoeff, aCoeff, b1, Vref, A0Vec, eld, noiseVec_rms, wLimVec, g3, optNoiseVec, optLeakyInt)
...
for a = 2:N
    ...
    for b = 1:nr_steps
        ...
        % NRZ DAC
        w4(ix) = w4(ix-1) + omega4*(   w4_in(ix) + noiseVec_rms(4)*randn()*sqrt(nr_steps));
