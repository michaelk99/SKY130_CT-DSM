...
function [y, fs, N, w1, w2, w3, w4, wsum, w1_in] = simDSM4CT_FF_2bit(OSR, ctSteps, fb, fin, fres, amplitude, offset, amplitude_inter, finter, omCoeff, cCoeff, Vref, A0Vec, eld, noiseVec_rms, wLimVec, optNoiseVec, optLeakyInt, optDACMismatch, optDAC)
...
for a = 2:N
    ...
    % 2-bit mid-rise DAC
    [y(a), thermoCode] = mbq(wsum(a), 4, Vref);
