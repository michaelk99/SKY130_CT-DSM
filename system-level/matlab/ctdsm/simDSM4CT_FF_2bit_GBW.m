...
function [y, fs, N, w1, w2, w3, w4, wsum] = simDSM4CT_FF_2bit_GBW(OSR, ctSteps, fb, fin, fres, amplitude, offset, omCoeff, cCoeff, Vref, noiseVec_rms, wLimVec, cVec, optNoiseVec)
...
for a = 3:N
    ...
    % 2-bit mid-rise DAC
    [y(ix+1:ix+nr_steps), thermoCode] = mbq(wsum(a), 4, Vref);
