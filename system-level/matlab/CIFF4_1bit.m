...
figure;
plot(w4MaxVec)
w1MaxMean = mean(w1MaxVec)
w2MaxMean = mean(w2MaxVec)
w3MaxMean = mean(w3MaxVec)
w4MaxMean = mean(w4MaxVec)

w1MaxVar = var(w1MaxVec)
w2MaxVar = var(w2MaxVec)
w3MaxVar = var(w3MaxVec)
w4MaxVar = var(w4MaxVec)
